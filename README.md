...
# (for regular Ruby, not that JRuby stuff)
$ rvm requirements
...
# When cd-ing into the folder, RVM will ask if you trust the .rvmrc file. Say yes.

# Install dependencies (using the bundler gem)
$ gem install bundler
$ bundle install
```